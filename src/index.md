...
(WARNING: it **will overwrite** but you have 3 seconds to press Ctrl+C if it's a mistake.)
...
then it **will overwrite** the `~/.kube/config` with one generated by `kubeconfig-ca-fetch`.
